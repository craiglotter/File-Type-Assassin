...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.Label4.Size = New System.Drawing.Size(336, 80)
        Me.Label4.TabIndex = 60
        Me.Label4.Text = "File Type Assassin is a simple application that is able to quickly move through a" & _
        " deep folder structure and delete all files based on the file types specified by" & _
        " the user. The clearing process is recursive in nature, meaning that all subdire" & _
        "ctories will be processed."
        '
        'Button3
        '
        ...
        Me.label22.ForeColor = System.Drawing.Color.Peru
        ...
        Me.Label23.ForeColor = System.Drawing.Color.Peru
        ...
        Me.Label19.ForeColor = System.Drawing.Color.Peru
        ...
        Me.Label12.ForeColor = System.Drawing.Color.Peru
        ...
        Me.Label11.ForeColor = System.Drawing.Color.Peru
        ...
        Me.Label13.Text = "FILE TYPES TO KILL"
        ...
        Me.Text = "File Type Assassin 1.0"
...
#End Region
    ...
    Private Sub Error_Handler(ByVal ex As Exception, Optional ByVal identifier_msg As String = "")
        ...
        Catch exc As Exception
            MsgBox("An error occurred in File Type Assassin's error handling routine. The application will try to recover from this serious error.", MsgBoxStyle.Critical, "Critical Error Encountered")
        End Try
    End Sub
    ...
    Public Sub Load_Registry_Values()
        Try
            ...
            For Each str In keys
                If str.Equals("Software\File Type Assassin") = True Then
                    keyflag1 = True
                    Exit For
                End If
            Next str
            ...
            If keyflag1 = False Then
                oReg.CreateSubKey("Software\File Type Assassin")
            End If

            keyflag1 = False

            Dim oKey As RegistryKey = oReg.OpenSubKey("Software\File Type Assassin", True)
    ...
    Private Sub btnAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAdd.Click
        Try
            ...
            Prompt1.Label1.Text = "Please enter the extension of the filetype you would like to kill. (e.g. jpg)"
